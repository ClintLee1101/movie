    ...
    <template v-if="!showLoading">
      <div class="subject-card">
        ...
        <div class="subject-info">
          <div class="right">
            <a href="#">
              <img v-if="subject.imgUrl" :src="subject.imgUrl" alt="cover">
            </a>
          </div>
          <div class="left">
        ...
        <div class="subject-pics">
          ...
          <ul v-if="subject.imgUrl">
            <li class="pic">
              <a href="javascript:;">
                <img :src="subject.imgUrl" alt="poster">
              </a>
            </li>
            <li class="pic">
              <a href="javascript:;">
      ...
      <div class="subject-comments">
        <h2 @click="goToDownLoad(subject.downUrl)">
          <a v-bind:href="subject.downUrl" target="_blank"></a>下载链接
        </h2>
...
//        genres: 'genres'
    ...
    methods: {
      ...
      getMovieDetail: function () {
        ...
        this.$http.get(`/api/movie/getMovieDetail/${id}?t=` + (new Date()).getTime().toString())
          .then((response) => {
            // 响应成功回调
...
//          JSON.stringify(response)
            ...
            this.summary = response.body.summary.substring(0, 20)
            this.subjectMeta = response.body.year + '/' + response.body.genres.join('/') + response.body.actors.join('/')
            console.log(this.subjectMeta)
          })
          .then((response) => {
